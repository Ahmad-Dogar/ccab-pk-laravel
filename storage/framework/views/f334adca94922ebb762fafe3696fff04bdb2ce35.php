...
serverSide: true,
ajax: {
url: "<?php echo e(route('probation.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('probation.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('probation.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('probation.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('probation.index')); ?>/" + delete_id + '/delete';
...
$('#probation_type_form')[0].reset();
$('#probation_type-table').DataTable().ajax.reload();
});<?php /**PATH /home/dtclbdc/hr.dtclbd.com/resources/views/settings/variables/JS_DT/probation_type_js.blade.php ENDPATH**/ ?>