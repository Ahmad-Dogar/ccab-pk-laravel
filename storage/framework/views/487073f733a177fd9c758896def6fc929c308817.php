        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title"> <?php echo e(__('Manual Attendance')); ?> </h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <form autocomplete="off" method="post" id="edit_form" class="form-horizontal" >
                            ...
                            <div class="row">
                                ...
                                <div hidden class="col-md-6 form-group">
                                    ...
                                    <br>
                                    <input type="checkbox" name="osd" id="osd" value=''>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dtclbdc/hr.dtclbd.com/resources/views/timesheet/updateAttendance/index.blade.php ENDPATH**/ ?>