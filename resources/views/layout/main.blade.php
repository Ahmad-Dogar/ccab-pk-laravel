        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                @endif
                    ...
                    <li class="has-dropdown {{ (request()->is('calendar*')) ? 'active' : '' }} {{ (request()->is('organization*')) ? 'active' : '' }} {{ (request()->is('settings*')) ? 'active' : '' }} {{ (request()->is('staff*')) ? 'active' : '' }} @if(request()->is('user*')){{ (request()->is('user*')) ? 'active' : '' }}@elseif(request()->is('add-user*')){{ (request()->is('add-user*')) ? 'active' : '' }}@endif">
