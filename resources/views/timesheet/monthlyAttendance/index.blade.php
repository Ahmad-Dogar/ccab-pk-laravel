    ...
    <section>
        <div class="container-fluid">
            ...
            <span class="attendace_mark_info mb-3">
                <small>{{trans('file.present')}} = P, Late present = LP , {{trans('file.Absent')}} = A  ,{{trans('file.Leave')}} = L  , {{trans('file.Holiday')}} = H  ,{{__('Off Day')}} = H</small>
            </span>
        </div>
        ...
        (function($) {
            ...
            const exportPDF = (dt) => {
               ...
               let keys = Object.keys(dataTableRows)
                ...
                $.ajax({
                        url:"{{ route('export_monthly_attendance_pdf.index') }}",
                        method:"POST",
                        data:{ value:data},
                        xhrFields: {
                              responseType: 'blob'
